                                    ...
                                    <c:if test="${recipes.dayName == planString.dayName}">
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                                <a href="/app/recipe/plan/delete?id=${recipes.recipePlanId}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                                <a href="/app/recipe/details?id=${recipes.recipeId}"><button type="button" class="btn btn-primary rounded-0">Szczegóły</button></a>
                                            </td>
                                        </tr>
                                    </c:if>
                                </c:forEach>
